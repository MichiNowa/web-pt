      ...
      <div class="modal-content">
        ...
        <div class="modal-body bg-dark">
          ...
          <form method="post" action="assets/php/actions.php?addpost" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label" style="color: #ff5500;">What's your Code about?</label>
              <textarea name="post_text" class="form-control bg-dark text-light" style="border-color: #ff5500;" id="exampleFormControlTextarea1" rows="1"></textarea>
            </div>
          ...
          <div class="d-flex align-items-center p-2">
            ...
            <div class="d-flex flex-column justify-content-center" <?= $post ?>>
              <a href='?u=<?= $fuser['username'] ?>' class="text-light">
                <h6 style="margin: 0px;font-size: small;" class="text-light"><?= $fuser['first_name'] ?>     <?= $fuser['last_name'] ?></h6>
              </a>
