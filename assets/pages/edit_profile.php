...
; border-radius:25px;">
            <form method="post" action="assets/php/actions.php?updateprofile" enctype="multipart/form-data">
                ...
                <!-- for confirmation if edit is successul or not -->
                <?php
                ...
                <div class="form-floating mt-1 col-md-6 col-sm-12">
                    <img src="assets/images/profile/<?= $user['profile_pic'] ?>"
                        class="img-thumbnail my-3 rounded-circle border-0" style="height:150px;width:150px" alt="...">
                    <div class="mb-3">
                        <label for="formFile" class="form-label" style="color: #ff5500;"><b>Change Profile
                                Picture</b></label>
                        <input class="form-control bg-dark text-light border-0" type="file" name="profile_pic"
                            id="formFile">
                    </div>
                </div>
                ...
                <div class="d-flex">
                    <div class="form-floating mt-1 col-6 ">
                        <input type="text" name="first_name" value="<?= $user['first_name'] ?>"
                            class="form-control rounded-5 text-light bg-dark border-0" placeholder="username/email">
                ...
                <div class="form-floating mt-1">
                    <!-- muted and disabled email because users may not change registered email -->
                    <input type="email" value="<?= $user['email'] ?>"
                        class="form-control rounded-5 text-muted bg-dark border-0" placeholder="email" disabled>
                ...
                <div class="text-end mt-2">
                    <input type="checkbox" name="pswd_show" id="pswd_show" onclick="pswd_toggle()"><small
                        style="color:#ff5500;"> Show
                        Password</small>
                </div>
                <div class="form-floating mt-1">
                    <input type="password" name="password" class="form-control rounded-5 bg-dark text-light border-0"
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                    <button class="btn btn text-light" style="background-color: #ff5500;border-radius:15px;"
