...
// if message is read or unread (para sa mga seener)
...
function validateSignupForm($form_data)
{
    ...
    if (isUsernameRegistered($form_data['username'])) {
        $response['msg'] = "Oopsies! Username is already in-use";
        $response['status'] = false;
        $response['field'] = 'username';
    }
...
function validateLoginForm($form_data)
{
    ...
    if (!$form_data['username_email']) {
        $response['msg'] = "Please enter your username/email";
        $response['status'] = false;
...
//for getting posts dynamically char
...
//for validating post if there is imge or not
function validatePostImage($image_data)
{
    ...
    if (!$image_data['name']) {
        $response['msg'] = "Oh no! You didn't include your snippet :(";
        $response['status'] = false;
